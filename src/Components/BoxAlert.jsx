            ...
            {type === 'empty' && (
                <>
                    <div className="flex p-4 mb-4 text-sm text-blue-700 bg-blue-100 rounded-lg dark:bg-blue-200 dark:text-blue-800" role="alert">
                        ...
                        <div>
                            <span className="font-medium">To-Do List is empty!</span> Add some tasks and try again.
                        </div>
                    </div>
                </>
            )}
            ...
            {type === 'warning' && (
                <>
                    <div className="flex p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800" role="alert">
                        ...
                        <span className="sr-only">Info</span>
                        <div>
                            <span className="font-medium">Could not find any tasks!</span> Please try again later.
                        </div>
                    </div>
                </>
            )}
